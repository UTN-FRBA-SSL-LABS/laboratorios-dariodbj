...
> R:sirve para inicializar el carrito c antes de empezar a usarlo
...
> R:esperado 2800, obtenido 350  (linea 48)
...
> R:linea 24 total += c->items[i].precio;  /* BUG: falta multiplicar por cantidad */
...
> R: c->cantidad <= MAX_ITEMS deberia ser c->cantidad < MAX_ITEMS
